    ...
    foreach($repositoris as $repositori){?>
        <table id='llista<?php echo $repositori->getId();?>' name='llista<?php echo $repositori->getId();?>' class="llista" width='90%' cellpadding='0' cellspacing='0' border='0'>
            <tr>
                ...
                <td width="20%" style="padding:5px;"><img src="../img/user.gif" height="25" onclick="carregaDiv('#users<?php echo $repositori->getId();?>', './admin/users.php?idRepo=<?php echo $repositori->getId();?>');" /><img src="../img/delete.png" height="25" onclick="carregaDiv('#help', './admin/consultes/deleterepo.php?id=<?php echo $repositori->getId();?>','llista<?php echo $repositori->getId();?>')" /></td>
            </tr>
        </table>
